...
Judge and Verifier remain the only evaluation strategies in this revision.
...
`HumanResponsePending` is recognized but not returned through the router;
deferred workflows are out of scope for this revision.
